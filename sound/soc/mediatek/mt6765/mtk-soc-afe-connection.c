...
bool SetAdcLchToModem2Out(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I03,
			   Soc_Aud_InterConnectionOutput_O17);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I03,
...
bool SetAdcRchToModem2Out(unsigned int ConnectionState)
{
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
			   Soc_Aud_InterConnectionOutput_O17);
	SetConnectionState(ConnectionState, Soc_Aud_InterConnectionInput_I04,
...
static const struct connection_link_t mConnectionLink[] = {
	...
	{Soc_Aud_AFE_IO_Block_ADDA_UL_LCH,
	 Soc_Aud_AFE_IO_Block_MODEM_PCM_2_O, SetAdcLchToModem2Out},
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH,
	 Soc_Aud_AFE_IO_Block_I2S3, SetAdcRchToI2s3},
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH,
	 Soc_Aud_AFE_IO_Block_I2S1_DAC, SetAdcRchToI2s1Dac},
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH,
	 Soc_Aud_AFE_IO_Block_I2S1_DAC_2, SetAdcRchToI2s1Dac2},
	{Soc_Aud_AFE_IO_Block_ADDA_UL_RCH,
	 Soc_Aud_AFE_IO_Block_MODEM_PCM_2_O, SetAdcRchToModem2Out},
	{Soc_Aud_AFE_IO_Block_MODEM_PCM_2_I_CH1,
