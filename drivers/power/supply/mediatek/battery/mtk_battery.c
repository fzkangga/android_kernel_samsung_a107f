...
static int usb_low_current;
static bool batt_slate_mode;
...
//+Bug446321,zhaosidong.wt,MODIFY,20190517,upgrade battery health while temperature change
...
//+bug 436431  modify getian.wt 20190419 battery thermal compatible
static char get_hwid[10];
static int get_hw_id(void)
{
	...
	if(!s1) {
		bm_err("hw_id not found in cmdline\n");
		return -1;
	}
	s1 += strlen("hw_id=");
	strncpy(get_hwid, s1, 3);
	get_hwid[3]='\0';
	bm_err("hw_id found in cmdline : %s\n", get_hwid);
...
//+bug 434514  modify getian.wt 20190321 disable battery temperature protect
	...
	return 25;
#endif
//-bug 434514  modify getian.wt 20190320 disable battery temperature protect
